...
public class LogisticsManagerController {
    ...
    @ApiOperation(value = "编辑logistics公司")
    @ApiImplicitParam(name = "id", value = "logistics公司ID", required = true, paramType = "path", dataType = "string")
    @PutMapping(value = "/{id}")
    ...
    @ApiOperation(value = "添加logistics公司")
    ...
    @ApiOperation(value = "删除logistics公司")
    @ApiImplicitParam(name = "id", value = "logistics公司ID", required = true, dataType = "String", paramType = "path")
